...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="flex justify-between px-10 md:px-20 py-5 bg-gray-900 items-center">
        ...
        {toggleDropdown && (<div className="bg-gradient-to-r from-sky-50 to-purple-50 z-30 text-center absolute right-9 top-11 mt-3 w-1/2 p-5 rounded-lg min-w-[210px] flex-col gap-2 justify-end items-end max-h-fit shadow-md shadow-black py-6">
        {isLoggedIn ?
        <>
                <Link
                  href="/create-note"
